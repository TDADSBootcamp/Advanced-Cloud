from aws_cdk import aws_ec2 as ec2, aws_iam as iam, core as cdk, aws_emr as emr


class EMRClusterStack(cdk.Construct):
    def __init__(
        self,
        scope: cdk.Construct,
        id: str,
        ...
        **kwargs,
        ...
        emr.CfnCluster(
            ...
            log_uri=f"s3://{s3_log_bucket}/{cdk.Aws.REGION}/elasticmapreduce/",
